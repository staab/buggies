// A chassis's frame of reference, read off its body each step: where it
// is, which way it faces, and how it is moving.

import type * as RAPIER from '@dimforge/rapier3d-compat'

import { qrotate, quat, v3, vadd, vcross, vscale, vsub, type Quat, type Vec3 } from '@buggies/physics'
...
export function velocityAtPoint(out: Vec3, body: RAPIER.RigidBody, frame: ChassisFrame, point: Vec3): Vec3 {
